...
(
    ...
    [DonViGiaoHang] [nvarchar]
(
    max
) NULL,
    [TenNguoiGiao] [nvarchar]
(
    max
) NULL,
    [SDTNguoiGiao] [nvarchar]
(
    max
) NULL,
    [TienGiaoHang] [decimal]
(
    20,
    0
) NULL,
    [NgayNhanHang] [datetime] NULL,
    [TenNguoiNhan] [nvarchar]
(
    max
) NULL,
    [SDTNguoiNhan] [nvarchar]
(
    max
) NULL,
    [EmailNguoiNhan] [nvarchar]
(
    max
) NULL,
